...
// Suite-wide Basilica look & feel - Firmament's M3 VECTOR variant (issue #4).
//
...
// Firmament's M3 editor is drawn at runtime with juce::Graphics/juce::Path:
// pointer knobs with engraved scale rings, lamp toggles, correlation needle
...
namespace basilica::gui
{
    ...
    public:
        ...
        // directly (BusPanel headers, CorrelationMeter legends).
        ...
        // CorrelationMeter's engraved arc/ticks/legend + needle over its opaque
        // recessed face.
